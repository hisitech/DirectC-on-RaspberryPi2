...
void dp_program_ulock(void)
{
    ...
    if (device_family & (AFS_BIT | SFS_BIT))
    {
        ...
        global_buf1[0] = (DPUCHAR) global_ulong1;
        global_buf1[1] = (DPUCHAR) ((global_ulong1 >> 8u) | 0x80u);
        global_buf1[2] = (DPUCHAR) ((global_ulong1 >> 16u) & 0x3Fu);
    ...
    else
    {
        ...
        /* Set the register content to be loaded into the chip */
        global_buf1[0] = (DPUCHAR) (global_ulong1 | 0x8u);
        global_buf1[1] = (DPUCHAR) ((global_ulong1 >> 8u) & 0xF3u);
        global_ulong1 = dp_get_bytes(SILSIG_ID,0u,4u);
        global_buf1[1] |= (DPUCHAR) (global_ulong1 << 4u);
        global_buf1[2] = (DPUCHAR) (global_ulong1 >> 4u);
        global_buf1[3] = (DPUCHAR) (global_ulong1 >> 12u);
        global_buf1[4] = (DPUCHAR) (global_ulong1 >> 20u);
        global_buf1[5] = (DPUCHAR) (global_ulong1 >> 28u);
    }
...
void dp_match_security(void)
{
    ...
    if (dat_support_status & SEC_DAT_SUPPORT_BIT)
    {
        ...
        global_ulong1 = dp_get_bytes(UKEY_ID,0u, 4u);
        global_ulong1 |= dp_get_bytes(UKEY_ID,4u, 4u);
        global_ulong1 |= dp_get_bytes(UKEY_ID,8u, 4u);
        global_ulong1 |= dp_get_bytes(UKEY_ID,12u, 4u);
